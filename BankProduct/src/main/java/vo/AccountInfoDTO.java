...
public class AccountInfoDTO {
	...
	public AccountInfoDTO(int accountId, String memberId, String bankCode, String branchCode, int productId,
	...
	public AccountInfoDTO(int int1, String string, String string2, String string3, int int2, int int3, String string4,
			int int4, String string5, int int5, int int6, Date date) {
